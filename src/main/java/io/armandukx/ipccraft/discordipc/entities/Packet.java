 ...
 */
package io.armandukx.ipccraft.discordipc.entities;
...
/**
 * A data-packet received from Discord via an {@link io.armandukx.ipccraft.discordipc.IPCClient IPCClient}.<br>
 * These can be handled via an implementation of {@link io.armandukx.ipccraft.discordipc.IPCListener IPCListener}.
 *
...
public class Packet
{
     ...
     * and the {@link io.armandukx.ipccraft.discordipc.IPCClient IPCClient}
     * connected.
     */
    public enum OpCode
    {
