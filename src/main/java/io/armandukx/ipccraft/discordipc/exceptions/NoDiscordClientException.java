...
/**
 * An exception thrown when an {@link io.armandukx.ipccraft.discordipc.IPCClient IPCClient}
 * when the client cannot find the proper application to use for RichPresence when
 * attempting to {@link io.armandukx.ipccraft.discordipc.IPCClient#connect(DiscordBuild...) connect}.<p>
 *
