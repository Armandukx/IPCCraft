 ...
 * These can be handled via an implementation of {@link io.armandukx.rpccraft.discordipc.IPCListener IPCListener}.
 *
...
public class Packet
{
     ...
     * and the {@link io.armandukx.rpccraft.discordipc.IPCClient IPCClient}
     * connected.
     */
    public enum OpCode
    {
