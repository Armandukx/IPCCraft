...
import io.armandukx.rpccraft.discordipc.entities.DiscordBuild;

/**
 * An exception thrown when an {@link io.armandukx.rpccraft.discordipc.IPCClient IPCClient}
 * when the client cannot find the proper application to use for RichPresence when
 * attempting to {@link io.armandukx.rpccraft.discordipc.IPCClient#connect(DiscordBuild...) connect}.<p>
 *
